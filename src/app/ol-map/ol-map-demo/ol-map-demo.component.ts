...
@Component({
  selector: 'app-ol-map-demo',
  templateUrl: './ol-map-demo.component.html',
  styleUrls: ['./ol-map-demo.component.scss']
})
export class OlMapDemoComponent implements OnInit, AfterViewInit {
