...
export class OlMapService {
     ...
     */
    showClusterMap(features: Feature<Geometry>[], style: ClusterStyle = {}): { source: Cluster, layer: VectorLayer<Cluster> } {
     ...
     * @returns 地图点击事件key
     */
    clusterClickEven(clustersLayer: VectorLayer<Cluster>) {
     ...
     * @returns 
     */
    markerAnimation(routeCoords: Array<any>): VectorLayer<VectorSource<Geometry>> {
